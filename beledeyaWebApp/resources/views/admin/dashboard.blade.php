                ...
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">{{__('main.Number of users')}}</h6>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">{{__('main.Number of complaints')}}
                            </h6>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">{{__('main.Number of requests for connection to public networks')}}
                            </h6>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">{{__('main.Number of building permit applications')}}</h6>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="border-top-0 px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3"><img
                                                        src="admin/assets/images/users/widget-table-pic1.jpg" alt="user"
                                    ...
                                    <tr>
                                        <td class="px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3"><img
                                                        src="admin/assets/images/users/widget-table-pic2.jpg" alt="user"
                                                        class="rounded-circle" width="45" height="45" /></div>
                                                <div class="">
                                    ...
                                    <tr>
                                        <td class="px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3"><img
                                                        src="admin/assets/images/users/widget-table-pic3.jpg" alt="user"
                                                        class="rounded-circle" width="45" height="45" /></div>
                                                <div class="">
                                                    <h5 class="text-dark mb-0 font-16 font-weight-medium">
                                                        Julian
                                    ...
                                    <tr>
                                        <td class="px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3"><img
                                                        src="admin/assets/images/users/widget-table-pic4.jpg" alt="user"
                                                        class="rounded-circle" width="45" height="45" /></div>
                                                <div class="">
