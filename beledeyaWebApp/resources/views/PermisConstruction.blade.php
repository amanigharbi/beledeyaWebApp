                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <p class=" text-light">Menzel Abderrahmane (arabe : منزل عبد الرحمان) est une
                                            ...
                                            kilomètres...</p>
>>>>>>> ef11feb019fa4ba6f54525891bdda1a24e84924e
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="white-button first-button scroll-to-section">
                                            <a href="#contact">Plus d'information<i class="fab fa-apple"></i></a>
...
<script>
    swal({ title: "Good job!", text: "{{ Session::get('success') }}", icon: "success", button: "download pdf", dangerMode: true }).then((value) => {
        open("{{asset('downPdfPermis')}}/{{session('permisConsId')}}");
    });
</script>
@endif @if (session('error'))
<script>
    swal({ title: "OPS!", text: "{{ Session::get('error') }}", icon: "warning", dangerMode: true });
</script>
@endif
                  ...
                  <div class="row register-form">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        @error('surface') {{ $message }} @enderror
                      </div>
                      <div class="maxl">
                ...
                <div class="row register-form">
                  <div class="col-md-5">
                    <form action="{{ asset('checkAutorisation') }}" method="GET">
                      @csrf
                      <div class="form-group">
                        <input type="text" class="form-control" name="num_autor" placeholder="Numéro Demande d'autorisation *"
                          value="{{ old('num_autor') }}" required />
                        @error('num_autor') {{ $message }} @enderror
                      </div>
                      <div class="form-group">
                        <input type="text" class="form-control" name="cin" placeholder="Numéro CIN *" value="{{ old('cin') }}"
                          required />
                        @error('cin') {{ $message }} @enderror
                      </div>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            @switch($autorisation->status) @case('0')
                                ...
                                <form action="{{ asset('checkAutorisation') }}" method="GET">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="num_autor"
                                            placeholder="Numéro Demande d'autorisation *" value="{{ old('num_autor') }}"
                                            required />
                                        @error('num_autor')
                                            {{ $message }}
                                        @enderror
