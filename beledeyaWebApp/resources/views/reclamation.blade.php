            ...
            <div class="col-md-9 register-right">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade @if ($rec == null) show active @endif" id="home"
                        ...
                        @if(session('recId'))
                            <a href="{{asset('downPdf')}}/{{session('recId')}}">Download</a>
                        @endif
                        @if (session('success'))
                            <div class="alert alert-success w-50 m-12 text-center">
                                {{ session('success') }}
                            </div>
    ...
    <div class="wrapper wrapper--w790">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item m-2" role="presentation">
                <button class="btn btn-danger @if ($rec == null) active @endif" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                    Nouvelle réclamation
                </button>
            </li>
            <li class="nav-item m-2" role="presentation">
                <button class="btn btn-danger @if ($rec != null) active @endif" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                    Suivi réclamation
                </button>
            </li>
        </ul>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ asset('addReclamation') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                <br />
                                <p>
                                    Les fichiers doivent peser moins de <b>2 Mo</b>.<br />
                                    Extensions autorisées : <b>gif jpg jpeg png</b>.
                                </p>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ asset('checkReclam') }}" method="GET">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="numRec" value="{{ old('numRec') }}" required />
                                        @error('numRec') {{ $message }} @enderror
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
