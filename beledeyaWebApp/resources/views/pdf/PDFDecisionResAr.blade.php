...
<p>  ان رئيسة بلدية منزل عبد الرحمان بعد اطلاعها على المطلب الذي تقدم به السيد/السيدة<b> {{$nom }} {{$prenom }} </b>لتزويد محله/ها الكائن ب<b> {{$adr}}</b> ب <b>{{$type}}</b> من طرف <b>{{$type_soc}}</b> </p>
    ...
    <p>واستنادا لمصادقة السيد والي بنزرت بتاريخ <b>{{$date_gouv}}</b> و جدول ارسال الولاية عدد 13/972 بتاريخ   
        <b>{{$date_gouv_ar}}</b></p>
...
<footer style="margin-top:22%;margin-left:45%">http://www.commune-menzel-abderrahmen.gov.tn</footer> 
