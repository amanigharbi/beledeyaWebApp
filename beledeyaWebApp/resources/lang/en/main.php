...
/** admin pages */
    ...
    "Number of requests for connection to public networks"=>"Requests for public networks",
    "Number of building permit applications"=>"Building permit applications",
    "Number of documents"=>"Documents",
    "percentage on claims" =>"Percentage on claims",
    "percentage on connection requests" =>"Percentage on connection requests",
    "percentage on construction requests" =>"Percentage on construction requests",
    "percentage according to claim status" =>"Percentage according to claim status",
    "percentage" =>"Percentage",
    "Percentage according to connection request status" =>"Percentage according to connection request status",
    "Percentage according to construction request status" =>"Percentage according to construction request status",
    "Users accounts" =>"Users accounts",
    "Email not confirmed" =>"Email not confirmed",
    "Registered users with email" =>"Registered users with email",
    "Registered users with google account" =>"Registered users with google account",
    "Rules" =>"Rules",
];